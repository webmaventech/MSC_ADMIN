...
<%
	String moduleName = "viewordersdetailspopup.jsp";
	String dummy5 = request.getParameter("orderNo");
	Util.setConsoleLog(moduleName, moduleName, "orderNo==>"+dummy5);
	int ono1 = 0;
	int listSize = 0;
	int totalAmount = 0;
		...
		<div class="box-inner">
			...
			<div class="box-content">
				...
				<div class="row">
					...
					<%
					double amount = ((obean1.getUnitPrice()) * (obean1.getQuantity()));
					totalAmount += amount;
					%>
					<div class="col-md-2">
